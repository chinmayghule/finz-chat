...
import CustomHeartSolidIcon from "./CustomHeartSolidIcon";

describe('CustomHeartSolidIcon', () => {
  it('should render svg: heart (solid) icon', () => {
    render(<CustomHeartSolidIcon />);

    const svgElement = screen.getByTestId('custom-heart-solid-icon');
